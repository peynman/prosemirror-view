...
export { serializeForClipboard as __serializeForClipboard, parseFromClipboard as __parseFromClipboard }
from "./clipboard"
export { endComposition as __endComposition }
from "./input"
...
export class EditorView {
    ...
    updateStateInner(state, reconfigured) {
        ...
        if (scroll == "reset") {
            ...
            if (this.someProp("handleScrollToSelection", f => f(this))) {} // Handled
